...
- A [Microsoft account](https://signup.live.com/){:target="_blank"} that you can use to sign into the Microsoft AI playground.
- Permission to download and upload an audio file on your computer.

Open the [MAI Playground](https://playground.microsoft.ai/){:target="_blank"} at `https://playground.microsoft.ai/`, and sign in using your Microsoft account.
